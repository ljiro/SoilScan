...
export default function ExportScreen({ navigation }) {
  ...
  const listHeader = (
    ...
    >
      ...
      {/* SAF Tip Box - Only show when SAF is enabled */}
      {Platform.OS === 'android' && safEnabled && (
        <View style={styles.safTipBox}>
          <Ionicons name="checkmark-circle" size={20} color={colors.primary} />
          <Text style={styles.safTipText}>
            With public storage enabled, your images and data are already accessible via file manager or USB - no export needed! ZIP export is available as a backup option.
          </Text>
        </View>
      )}
  ...
  const listFooter = (
    <View style={styles.container}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionTitle}>
              {safEnabled ? 'Backup Export (Optional)' : 'Export as ZIP'}
            </Text>
          </View>
          {safEnabled && (
            <Text style={styles.sectionDescription}>
              Since public storage is enabled, your files are already accessible. Use ZIP export only if you need a portable backup.
            </Text>
          )}
          <TouchableOpacity
            style={[
      ...
      <View style={[styles.section, groups.length === 0 && styles.sectionFirst]}>
        <View style={styles.sectionHeader}>
      ...
      <View style={styles.tipBox}>
        ...
        <Text style={styles.tipText}>
          {safEnabled
            ? 'Your data is saved to public storage and accessible via any file manager or when connected via USB.'
