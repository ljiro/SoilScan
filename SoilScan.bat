...
echo.
echo   Example: C:\Users\Name\Documents\soil_samples
echo.
...
echo.
echo   Enter the path where processed images will be saved.
...
set "ARGS=-i "!INPUT_DIR!" -o "!OUTPUT_DIR!""
